<div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <form id="form-validation" action="<?php echo BASE_URL?>/category/insert_category" method="post" class="form-horizontal form-box remove-margin" novalidate="novalidate" abineguid="BCB3BE931B734E38B58BD9979060DF74">
                        <!-- Form Header -->
                        <h4 class="form-box-header">Thêm danh mục</h4>

                        <!-- Form Content -->
                        <div class="form-box-content">
                            <div class="form-group">
                                <label class="control-label col-md-2" for="val_username">Tên danh mục</label>
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-user fa-fw"></i></span>
                                        <input type="text" id="val_username" name="name_category" class="form-control" required>
