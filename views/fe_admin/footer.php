        ...
        <script>!window.jQuery && document.write(decodeURI('%3Cscript src="<?php echo BASE_URL?>/public/admin/js/vendor/jquery-1.11.1.min.js"%3E%3C/script%3E'));</script>

        <!-- Bootstrap.js -->
        <script src="<?php echo BASE_URL?>/public/admin/js/vendor/bootstrap.min.js"></script>
