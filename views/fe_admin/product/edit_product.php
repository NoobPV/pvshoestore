...
<div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="">Sửa sản phẩm</a></li>
                    </ul>
                    <?php
	                    foreach($productbyid as $key => $prod){?>
                    <!-- END Navigation info -->
                    <form id="form-validation" action="<?php echo BASE_URL ?>/product/update_product/<?php echo $prod['id']?>" method="post" class="form-horizontal form-box remove-margin" novalidate="novalidate" abineguid="BCB3BE931B734E38B58BD9979060DF74"  enctype="multipart/form-data">
                        <!-- Form Header -->
                        ...
                        <div class="form-box-content">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="val_username" name="name_product" class="form-control" value="<?php echo $prod['name_product'];?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input type="file" id="val_email" name="image_product" class="form-control">
                                        <div><img src="<?php echo BASE_URL ?>/public/images/product/<?php echo $prod['image_product'] ?>" height="100" width="100"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea id="example-textarea" name="detail_product" class="form-control" row="6"><?php echo $prod['detail_product'];?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2" for="val_skill">Danh mục sản phẩm</label>
                                <div class="col-md-2">
                                    <select id="val_skill" name="id_category" class="form-control" required>
                                        <?php
                                            foreach($category as $key => $cate){?>
                                            <option <?php if($prod['id_category']==$cate['id']){ echo 'selected'; }?> value="<?php echo $cate['id'] ?>"><?php echo $cate['name_category'] ?></option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
