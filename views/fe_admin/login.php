...
<!--===============================================================================================-->
	...
	<link rel="stylesheet" type="text/css" href="./public/login/css/mains.css">
<!--===============================================================================================-->
<body>
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="<?php echo BASE_URL?>/login/authentication_login" method="post">
					<span class="login100-form-title">
						Member Login
					</span>
                    	<?php
                            if(isset($msg)){
                                echo '<span class="txt1" style="color:red;text-align:center;font-size:1rem; display:block">'.$msg.'</span>';
                            }
                        ?>
					...
					<div class="container-login100-form-btn">
						<input name="submit" value="Login" type ="submit" class="login100-form-btn">					
					</div>
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="<?php echo BASE_URL?>/register/form_register">
							Create your Account
